...
public class TrailerAdapter extends RecyclerView.Adapter<TrailerAdapter.TrailerHolder> {
    ...
    public TrailerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = trailerInflator.inflate(R.layout.custom_movies_card,parent,false);
    ...
    public class TrailerHolder extends RecyclerView.ViewHolder{
        ...
        public TrailerHolder(@NonNull View itemView) {
            ...
            name = itemView.findViewById(R.id.cardMovieTitle);
            tumbnail = itemView.findViewById(R.id.moviePoster);
