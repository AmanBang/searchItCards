package com.animasium.searchitcards.Anime.Adapter;
...
public class AnimeSearchShow extends RecyclerView.Adapter<AnimeSearchShow.AnimeHolder> {
    LayoutInflater animeInflatorSearch;
    List<Topresults> animeResultSearch;

    public AnimeSearchShow(Context animeSearchCtx, List<Topresults> animeResultSearch){
